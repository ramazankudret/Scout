...
class LearnedLesson(Base, TimestampMixin):
    ...
    prevention_strategy: Mapped[Optional[str]] = mapped_column(Text)
    category: Mapped[Optional[str]] = mapped_column(String(50))
    severity: Mapped[Optional[str]] = mapped_column(String(20))
    recommended_checks: Mapped[dict] = mapped_column(JSONB, default=list)
    occurrence_count: Mapped[int] = mapped_column(Integer, default=1)
    effectiveness_rate: Mapped[Optional[float]] = mapped_column(Numeric(5, 2))
